import os,subprocess, shutil, requests, winreg, stat, time, ctypes, zipfile, platform
import sys
...
def winget_install_multiple(package_list):
    for package in package_list:
        print(f"Installing {package}")
        subprocess.run(["powershell", "-Command", "winget", "install", package], shell=True, check=True)
